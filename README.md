...
**Metadata Filtering**: Filter by topic and difficulty level using LLM
...
| **স্বাস্থ্য** | সর্দি-কাশির জন্য কী করব?  |
...
- Bengali SBERT model by [L3Cube Pune](https://github.com/l3cube-pune)